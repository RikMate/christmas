...
function createNewElement(obj, form, array) {
    ...
    const dropdownlist = getSelectElement();
    createoption(dropdownlist, obj.who1, obj.who1);
    if(obj.who2)
    {
        createoption(dropdownlist, obj.who2, obj.who2);
    }
    ...
    form.reset();
    // ismerős rész vége
    const idk = document.getElementById("#masodikmano");
    changeCheckboxValue(idk);
}
